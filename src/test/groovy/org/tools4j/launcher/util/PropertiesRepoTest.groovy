 ...
 * Time: 5:35 PM
 */
class PropertiesRepoTest extends Specification {
    ...
    def setup(){
        ...
        repo = new PropertiesRepo(properties);
    }
    ...
    def "GetWithPrefix 1"() {
        when:
        final PropertiesRepo redRepo = repo.getWithPrefix("red");
    ...
    def "GetWithPrefix 3"() {
        given:
        final PropertiesRepo blackCarRepo = repo.getWithPrefix("black.car");
        ...
        final PropertiesRepo blackCarEngineRepo = blackCarRepo.getWithPrefix("engine");
